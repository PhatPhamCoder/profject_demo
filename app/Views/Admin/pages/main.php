...
<head>
    ...
    <base href="<?= base_url() ?>">
    <title>Web Admin Master</title>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.1/css/all.css"
        integrity="sha384-5sAR7xN1Nv6T6+dT2mhtzEpVJvfS3NScPQTrOxhwjIuvcA67KV2R5Jz6kr4abQsz" crossorigin="anonymous">
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600|Open+Sans:400,600,700" rel="stylesheet">
    <link rel="stylesheet" href="/project-demo/public/assets/admin/css/easion.css">
...
<body>
    <div class="dash">
        ...
        <div class="dash-app">
            <header class="dash-toolbar">
                ...
                <div class="tools">
                    <a href="https://www.youtube.com/channel/UCwBHZqLqgZUTWLLaQLfoJ1g?sub_confirmation=1"
                        target="_blank" class="tools-item">
    ...
    <script src="/project-demo/public/assets/admin/js/easion.js"></script>
</body>
